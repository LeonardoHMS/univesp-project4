...
DATAFRAME = os.environ.get("PLANILHA")

# Configuração da página
st.set_page_config(page_title="Análise de Acidentes 2025", layout="wide")

# Leitura e preparação dos dados
df = pd.read_csv(DATAFRAME, encoding='latin1', sep=';')
...
select_accident_type = st.sidebar.multiselect(
    "Tipo de Acidente",
...
# Filtragem inicial
df_temp = df[(df['uf'].isin(selected_uf)) & (df['tipo_acidente'].isin(select_accident_type))]
